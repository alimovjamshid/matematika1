...
class PlayActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        courseList = courseList + Item("Og'ir-yengil", R.drawable.kop)
        courseList = courseList + Item("Ertalab-kechqurun", R.drawable.kop)
        courseList = courseList + Item("Qo'shish-ayirish", R.drawable.kop)
        courseList = courseList + Item("Kvadrat", R.drawable.kop)
        courseList = courseList + Item("1 soni va raqami", R.drawable.kop)
        courseList = courseList + Item("Nuqta.To'g'ri va egri chiziq", R.drawable.kop)
        courseList = courseList + Item("2 soni va raqami", R.drawable.kop)
        courseList = courseList + Item("3 soni va raqami", R.drawable.kop)
        courseList = courseList + Item("4 soni va raqami", R.drawable.kop)
        courseList = courseList + Item("5 soni va raqami", R.drawable.kop)
        courseList = courseList + Item("0 soni va raqami", R.drawable.kop)
        courseList = courseList + Item("6 soni va raqami", R.drawable.kop)
        courseList = courseList + Item("7 soni va raqami", R.drawable.kop)
        courseList = courseList + Item("8 soni va raqami", R.drawable.kop)
        courseList = courseList + Item("To'g'ri chiziq yasash", R.drawable.kop)
        courseList = courseList + Item("Shar va kub", R.drawable.kop)
        courseList = courseList + Item("9 soni va raqami", R.drawable.kop)
        courseList = courseList + Item("10 soni va raqami", R.drawable.kop)
